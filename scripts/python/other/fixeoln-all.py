...
Examples: 
        python fixeoln-all.py tounix /Stuff/websites             # on Unix, utf8
        python3 docetc/fixeoln-all.py todos . utf8               # on Unix
        py -3 docetc\fixeoln-all.py tounix ..\uploaddir latin1   # on Windows
